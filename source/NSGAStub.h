...
namespace Algorithm
{
	namespace Stubs
	{
		...
		/// <summary><c>GaNSGAStubBase</c> is base class for stubs that implement NSGA.
		///
		/// This class has no built-in synchronizator, so <c>LOCK_OBJECT</c> and <c>LOCK_THIS_OBJECT</c> macros cannot be used with instances of this class.
		/// No public or private methods are thread-safe.</summary>
		class GaNSGAStubBase : public GaBasicStub
		{
		...
		public:
			...
			/// <summary>Initializes NSGA stub with population on which it will operate and all operations and parameters.</summary>
			...
			GAL_API
			GaNSGAStubBase(int populationID,
				int statisticsID,
		...
		protected:
			...
			/// <summary><c>UpdatePopulationParameters</c> method performs update of algorithm's stub accordint to new population parameters.</summary>
			/// <param name="params">new population parameters.</param>
			GAL_API
			void GACALL UpdatePopulationParameters(Population::GaPopulationParams& params);

			/// <summary><c>UpdateSelectionParameters</c> method performs update of algorithm's stub accordint to new selection parameters.</summary>
			/// <param name="params">new selection parameters.</param>
			GAL_API
			void GACALL UpdateSelectionParameters(Population::GaSelectionParams& params);
			...
			virtual bool GACALL IsCouplingUsed() const = 0;
		...
		/// <summary><c>GaNSGAStub</c> class represents stub that implement NSGA.
		///
		/// This class has no built-in synchronizator, so <c>LOCK_OBJECT</c> and <c>LOCK_THIS_OBJECT</c> macros cannot be used with instances of this class.
		/// No public or private methods are thread-safe.</summary>
		class GaNSGAStub : public GaNSGAStubBase
		{
		...
		protected:
			...
			Population::SelectionOperations::GaRouletteWheelSelection _selectionOperation;

			/// <summary>Replacement operation used by the algorithm</summary>
			Population::ReplacementOperations::GaPopulationReplacement _replacementOperation;

			/// <summary>NSGA parameters.</summary>
			Multiobjective::NSGA::GaNSGAParams _nsgaParameters;

			/// <summary>NSGA operation.</summary>
			Multiobjective::NSGA::GaNSGA _nsgaOperation;

			/// <summary>Comparator that measures distance between chromosomes.</summary>
		...
		public:
			...
			GaNSGAStub(int populationID,
				...
				const Multiobjective::NSGA::GaNSGAParams& nsgaParameters);

			/// <summary>Initializes NSGA stub without population on which it will operate and with default operations and parameters.</summary>
			GaNSGAStub() { Clear(); }
			...
			{
				GaNSGAStubBase::UpdateSelectionParameters( params );
				_selectionParameters = params;
			}

			/// <summary><c>SetChromosomeComparator</c> method sets new comparator that will be used for measuring distance between chromosomes.
			///
			/// This method is not thread-safe.</summary>
			/// <param name="comparator">new chromosome comparator.</param>
			GAL_API
			void GACALL SetChromosomeComparator(const Chromosome::GaChromosomeComparatorSetup& comparator);

			/// <summary><c>SetNSGAParameters</c> method sets parameters for NSGA operation.
			///
			/// This method is not thread-safe.</summary>
			/// <param name="params">new NSGA parameters.</param>
			GAL_API
			void GACALL SetNSGAParameters(const Multiobjective::NSGA::GaNSGAParams& params);

		protected:

			/// <summary><c>IsCouplingUsed</c> method determins whether the coupling operation is used.</summary>
			/// <returns>Method returns <c>true</c> if the coupling step is used.</returns>
			virtual bool GACALL IsCouplingUsed() const { return _selectionParameters.GetCrossoverBuffersTagID() < 0; }
		...
		/// <summary><c>GaNSGA2Stub</c> class represents stub that implement NSGA-II.
		///
		/// This class has no built-in synchronizator, so <c>LOCK_OBJECT</c> and <c>LOCK_THIS_OBJECT</c> macros cannot be used with instances of this class.
		/// No public or private methods are thread-safe.</summary>
		class GaNSGA2Stub : public GaNSGAStubBase
		{

		protected:

			/// <summary>Fitness comparator used for sorting chromosomes in the population.</summary>
			Fitness::Comparators::GaPositionalComparator _scaledFitnessComparator;

			/// <summary>Parameters of selection operation.</summary>
			Population::SelectionOperations::GaTournamentSelectionParams _selectionParameters;
			...
			/// <summary>NSGA parameters.</summary>
			Multiobjective::NSGA::GaNSGA2Params _nsgaParameters;

			/// <summary>NSGA operation.</summary>
			Multiobjective::NSGA::GaNSGA2 _nsgaOperation;

			/// <summary>Flow step that trims population to required size at the end of the generation.</summary>
			Common::Workflows::GaFlowStep* _trimStep;

		public:

			/// <summary>Initializes NSGA-II stub with population on which it will operate and all operations and parameters.</summary>
			/// <param name="populationID">ID of the population on which the stub will operate.</param>
			/// <param name="statisticsID">ID of the object that whill store statistical information.</param>
			/// <param name="initializator">initialization operation for the population.</param>
			/// <param name="fitnessOperation">fitness operation that evaluates chromosomes in the population.</param>
			...
			GaNSGA2Stub(int populationID,
				...
				const Multiobjective::NSGA::GaNSGA2Params& nsgaParameters);

			/// <summary>Initializes NSGA-II stub without population on which it will operate and with default operations and parameters.</summary>
			GaNSGA2Stub() { Clear(); }
			...
			/// <param name="params">new NSGA parameters.</param>
			GAL_API
			void GACALL SetNSGAParameters(const Multiobjective::NSGA::GaNSGA2Params& params);
